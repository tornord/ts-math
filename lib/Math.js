...
exports.round = exports.quantile = exports.centralWeightedStdev = exports.normalCdf = exports.normalInv = exports.erfcinv = exports.erfc = exports.erf = exports.kurtosis = exports.skew = exports.corr = exports.stdev = exports.mean = exports.sum = exports.sqr = void 0;
...
function erf(z) {
    var cof = [
        -1.3026537197817094, 6.4196979235649026e-1, 1.9476473204185836e-2, -9.561514786808631e-3, -9.46595344482036e-4, 3.66839497852761e-4,
        4.2523324806907e-5, -2.0278578112534e-5, -1.624290004647e-6, 1.30365583558e-6, 1.5626441722e-8, -8.5238095915e-8, 6.529054439e-9,
 ...
 */
function centralWeightedStdev(vs) {
    vs.sort((d1, d2) => d1 - d2);
    var swx = 0.0;
    var swx2 = 0.0;
    var sw = 0.0;
...
exports.centralWeightedStdev = centralWeightedStdev;
/**
